...
vim.opt.linebreak = true        -- wrap at word bounderies
...
vim.opt.smarttab = true         -- enters shiftwidth at line start
...
vim.opt.showmode = false                    -- shows current mode in command area (often disabled if statusline shows the curretn mode)
